...
export default class OutfitDetails extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={{ flex: 1, marginTop: -50 }}>
          ...
          <Animated.ScrollView
            ...
            <View style={styles.contentContainerStyle}>
              ...
              />
              <SummaryCard text={outfit.summary} />
              <DescriptionCard text={outfit.description} />
              <InstagramPhotosCard profile={outfit.instagram} />
              <VisitedCard outfit={this.props.outfit} />
            </View>
          </Animated.ScrollView>
        </View>
        ...
        <StatusBar barStyle={getBarStyle(outfit.color)} />
      </View>
    );
  }
  ...
  _renderNavigationBar() {
    let { color, accentColor } = this.props.outfit;
  ...
  _handlePressDirections = () => {
    let { address, postalCode, city } = this.props.outfit;

...
const MenuOptions = ['All', 'Nearby', 'Visited', 'Not Visited'];

@connect()
export default class OutfitListScreen extends React.Component {
  static route = {
    navigationBar: {
      visible: false,
    },
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {selectedOption === 'All' && <OutfitList {...defaultListProps} />}
        {selectedOption === 'Nearby' && (
          <OutfitList {...defaultListProps} nearby />
        )}
        {selectedOption === 'Visited' && (
          <OutfitList {...defaultListProps} visited />
        )}
        {selectedOption === 'Unvisited' && (
          <OutfitList {...defaultListProps} notVisited />
        )}
          ...
          <TouchableWithoutFeedback
            ...
            <View style={{ flexDirection: 'row' }}>
              <BoldText style={styles.navigationBarTitle}>
                {this.state.selectedOption} Suite Spaces
              </BoldText>
